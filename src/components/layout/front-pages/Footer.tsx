      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <Typography className='text-white opacity-[0.92]' variant='body2'>
            ...
            <span>{`❤️`}</span>
            <span>{` by `}</span>
            <Link href='https://lyrae.fr' target='_blank' className='font-medium text-white'>
              APLUS
            </Link>
          </Typography>
          <div className='flex gap-1.5 items-center opacity-[0.78]'>
            <IconButton component={Link} size='small' href='https://github.com/aplus' target='_blank'>
              <i className='ri-github-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.facebook.com/aplus/' target='_blank'>
              <i className='ri-facebook-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://twitter.com/aplus' target='_blank'>
              <i className='ri-twitter-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.linkedin.com/company/aplus' target='_blank'>
